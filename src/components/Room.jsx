...
// ── 主组件 ──
export default function Room({ theme: t, bgmOn, setBgmOn, mode, onEnterPrivate, onEnterNuonuo, onEnterBedroom, onEnterKitchen, onEnterStudy }) {
  ...
  function handleClick(id) {
    ...
    if (id === "study")       { onEnterStudy(); return; }
