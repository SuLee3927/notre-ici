...
const FURNITURE = [
  ...
  { id:"board",       left:"73%", top:"56%", floor:true, transparent:true, w:"clamp(40px,11vw,62px)", h:"clamp(30px,8vw,50px)" },
  ...
  { id:"tv",          left:"82%", top:"38%", transparent:true, w:"clamp(40px,11vw,64px)", h:"clamp(32px,9vw,56px)" },
];
