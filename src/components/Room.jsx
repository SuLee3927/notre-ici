...
const FURNITURE = [
  ...
  { id:"board",       left:"73%", top:"55%", floor:true, transparent:true, w:"clamp(44px,12vw,68px)", h:"clamp(36px,10vw,60px)" },
  ...
  { id:"tv",          left:"82%", top:"40%", transparent:true, w:"clamp(40px,11vw,64px)", h:"clamp(32px,9vw,56px)" },
];
